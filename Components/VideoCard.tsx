                ...
                >
                    <Link href={`/detail/${post._id}`}>
                        <video
                            loop
                            ref={videoRef}
                            className='lg:w-[700px] h-[300px] md:h-[400px] lh:h-[530px] w-[250px] rounded-2xl cursor-pointer bg-gray-100 relative'
